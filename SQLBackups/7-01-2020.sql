...
INSERT INTO `bank_accounts` VALUES (3,'JS Bank','Subhan','32432342234432','2020-01-03 08:47:18','2020-01-07 10:11:14');
...
INSERT INTO `invoices` VALUES (13,5,1,87,'2020-01-01','2020-01-31',3000,15,9,'das',5,1,'2020-01-07 04:09:35','2020-01-07 04:14:57'),(15,5,1,85,'2020-01-01','2020-01-31',100,7,10,'dsa',NULL,1,'2020-01-07 12:04:20','2020-01-07 12:04:20');
...
INSERT INTO `users` VALUES (1,'Admin','admin@realestate.com',NULL,'$2y$10$eMgUi1v3s.a5xXJDYyv7muDG505.xSwFRL/kDL/u0xpcJVo7o9M5q',NULL,1,'DHa','123456789',9,'/files/1578044875profile-avatar.png','2019-12-31 10:22:21','2020-01-03 08:43:27'),(2,'Land Lord','landlord@realestate.com',NULL,'$2y$10$yQNGD0mwIEHKnBDfNnmeYOpUKF5LYP5NV.y6BQmemH0ESQO.Inc0y',NULL,2,NULL,NULL,9,NULL,'2019-12-31 10:22:21','2019-12-31 10:22:21'),(4,'uzair khan','root@email.com',NULL,NULL,NULL,2,NULL,NULL,9,NULL,'2020-01-07 12:17:23','2020-01-07 12:17:23');
...
INSERT INTO `widgets` VALUES (5,'Total Active Properties',NULL,'select count(id) as value from properties where exists( select  * from statuses where properties.property_status_id = statuses.id and slug = \'active\' and module = \'properties\')',18,'1',NULL,NULL,NULL,11,'2020-01-07 05:08:27','2020-01-07 11:44:55'),(6,'Total Active Land Lords',NULL,'select count(id) as value from users where exists( select  * from statuses where users.user_status_id = statuses.id and slug = \'active\' and module = \'users\')  and exists( select  * from roles where users.role_id = roles.id and slug = \'land-lord\')',18,'2',NULL,NULL,NULL,11,'2020-01-07 06:25:47','2020-01-07 11:44:59'),(7,'Total Active Tenants',NULL,'select count(id) as value from tenants where exists( select  * from statuses where tenants.tenant_status_id = statuses.id and slug = \'active\' and module = \'tenants\')',18,'3',NULL,NULL,NULL,11,'2020-01-07 06:29:13','2020-01-07 11:45:04'),(8,'Total Active Properties',NULL,'select count(id) as value from properties where exists( select  * from statuses where properties.property_status_id = statuses.id and slug = \'active\' and module = \'properties\') and land_lord_id = [USER_ID]',18,'4',NULL,NULL,NULL,11,'2020-01-07 06:42:21','2020-01-07 11:43:20'),(9,'Total Earning Report',NULL,NULL,19,'6',NULL,'invoice','makeTotalEarningsDataTable',12,'2020-01-07 07:30:34','2020-01-07 14:15:09'),(10,'Total Transactions',NULL,NULL,18,'5',NULL,'invoice','makeTotalTransactionsDataTable',12,'2020-01-07 08:14:30','2020-01-07 13:14:30'),(11,'Total Properties',NULL,NULL,18,'7',NULL,'property','makeTotalPropertiesDataTable',12,'2020-01-07 09:13:44','2020-01-07 14:13:44'),(12,'Total Tenants',NULL,NULL,18,'8',NULL,'tenant','makeTotalTenantsDataTable',12,'2020-01-07 09:16:10','2020-01-07 14:16:10'),(13,'Total Land Lords',NULL,NULL,18,'9',NULL,'user','makeTotalLandLordsDataTable',12,'2020-01-07 09:24:00','2020-01-07 14:24:18'),(14,'Total Units',NULL,'select count(id) as value from units',18,NULL,NULL,NULL,NULL,11,'2020-01-07 10:13:01','2020-01-07 15:13:35'),(15,'Vacant Units',NULL,'select count(id) as value from units where exists( select  * from statuses where units.unit_status_id = statuses.id and slug = \'active\' and module = \'units\')',18,NULL,NULL,NULL,NULL,11,'2020-01-07 10:14:07','2020-01-07 15:15:54'),(16,'Total Units',NULL,'select count(id) as value from units where exists( select  * from properties where units.property_id = properties.id and exists(select  * from users where properties.land_lord_id = [USER_ID]))',18,NULL,NULL,NULL,NULL,11,'2020-01-07 10:17:09','2020-01-07 15:20:44'),(17,'Vacant Units',NULL,'select count(id) as value from units where exists( select  * from statuses where units.unit_status_id = statuses.id and slug = \'active\' and module = \'units\') and exists( select  * from properties where units.property_id = properties.id and exists(select  * from users where properties.land_lord_id = [USER_ID]))',18,NULL,NULL,NULL,NULL,11,'2020-01-07 10:21:02','2020-01-07 15:21:44');
...
INSERT INTO `widgets_roles` VALUES (66,5,1,'2020-01-07 06:45:13','2020-01-07 06:45:13'),(67,6,1,'2020-01-07 06:45:17','2020-01-07 06:45:17'),(68,7,1,'2020-01-07 06:45:28','2020-01-07 06:45:28'),(69,7,2,'2020-01-07 06:45:28','2020-01-07 06:45:28'),(75,8,2,'2020-01-07 08:01:00','2020-01-07 08:01:00'),(76,10,1,'2020-01-07 08:14:30','2020-01-07 08:14:30'),(79,11,1,'2020-01-07 09:13:44','2020-01-07 09:13:44'),(80,9,1,'2020-01-07 09:15:09','2020-01-07 09:15:09'),(81,12,1,'2020-01-07 09:16:10','2020-01-07 09:16:10'),(83,13,1,'2020-01-07 09:24:18','2020-01-07 09:24:18'),(85,14,1,'2020-01-07 10:13:35','2020-01-07 10:13:35'),(88,15,1,'2020-01-07 10:15:54','2020-01-07 10:15:54'),(90,16,2,'2020-01-07 10:20:44','2020-01-07 10:20:44'),(92,17,2,'2020-01-07 10:21:44','2020-01-07 10:21:44');
...
-- Dump completed on 2020-01-07 22:24:37

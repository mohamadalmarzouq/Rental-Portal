...
@section('main')
    ...
    <div id="report-setting-modal"></div>
@endsection
...
@push('custom-scripts')
    ...
    <script type="text/javascript">
        ...
        function openReportSettingModal(report_id) {

            let requested_url = base_url + '/{{ $module }}-add';

            $.get(requested_url,{ 'report_id' : report_id}).done(function (data) {

                console.log(data);
                $('#report-setting-modal').html(data);

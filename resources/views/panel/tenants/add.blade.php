                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="mb-1 tx-medium">{{ tn('Name (required)') }}</label>
                                <input type="text" name="name" id="name" class="form-control" placeholder="{{ tn('Name') }}">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="mb-1 tx-medium">{{ tn('Contact Number (required)') }}</label>
                                <input type="number" name="contact_number" id="contact_number" class="form-control"
                                       placeholder="{{ tn('Contact Number') }}" maxlength="10">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="mb-1 tx-medium">{{ tn('Email ID') }}</label>
                                <input type="email" name="email" id="email" class="form-control" placeholder="{{ tn('Email ID') }}"
                                >
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="mb-1 tx-medium">{{ tn('National ID (required)') }}</label>
                                <input type="number" name="national_id" id="national_id" class="form-control"
                                       placeholder="{{ tn('National ID') }}">
                            </div>
                        </div>

                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="mb-1 tx-medium">{{ tn('Age') }}</label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="" class="mb-1 tx-medium">{{ tn('Gender') }}</label>
                                <select name="gender" id="gender" class="form-control">
                                    <option value="male">{{ tn('Male') }}</option>
                                    <option value="female">{{ tn('Female') }}</option>
                                </select>
                            </div>
                        </div>
